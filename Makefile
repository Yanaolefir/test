...
# Generated by qmake (2.01a) (Qt 4.8.4) on: ?? 15. ??? 11:52:34 2016
# Project:  test.pro
# Template: app
# Command: c:\Qt\4.8.4\bin\qmake.exe -spec ..\Qt\4.8.4\mkspecs\win32-g++ CONFIG+=declarative_debug -o Makefile test.pro
#############################################################################
...
Makefile: test.pro  ../Qt/4.8.4/mkspecs/win32-g++/qmake.conf ../Qt/4.8.4/mkspecs/features/device_config.prf \
	...
	$(QMAKE) -spec ..\Qt\4.8.4\mkspecs\win32-g++ CONFIG+=declarative_debug -o Makefile test.pro
